...
public class headers extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6041163521855171768L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"headers\",\"namespace\":\"com.hughes.billing.voipworkorder.dto.avro.ack\",\"fields\":[{\"name\":\"KEY\",\"type\":\"string\"}]}");
   ...
   */
  public static com.hughes.billing.voipworkorder.dto.avro.ack.headers.Builder newBuilder() {
    return new com.hughes.billing.voipworkorder.dto.avro.ack.headers.Builder();
  }
   ...
   * @return A new headers RecordBuilder
   */
  public static com.hughes.billing.voipworkorder.dto.avro.ack.headers.Builder newBuilder(com.hughes.billing.voipworkorder.dto.avro.ack.headers.Builder other) {
    return new com.hughes.billing.voipworkorder.dto.avro.ack.headers.Builder(other);
  }
   ...
   * @return A new headers RecordBuilder
   */
  public static com.hughes.billing.voipworkorder.dto.avro.ack.headers.Builder newBuilder(com.hughes.billing.voipworkorder.dto.avro.ack.headers other) {
    return new com.hughes.billing.voipworkorder.dto.avro.ack.headers.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<headers>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.hughes.billing.voipworkorder.dto.avro.ack.headers.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.hughes.billing.voipworkorder.dto.avro.ack.headers other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.KEY)) {
        this.KEY = data().deepCopy(fields()[0].schema(), other.KEY);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hughes.billing.voipworkorder.dto.avro.ack.headers.Builder setKEY(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hughes.billing.voipworkorder.dto.avro.ack.headers.Builder clearKEY() {
      KEY = null;
