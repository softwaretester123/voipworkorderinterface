...
public class InstallPhone extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3109678067031513866L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"InstallPhone\",\"namespace\":\"com.hughes.billing.voipworkorder.dto.avro\",\"fields\":[{\"name\":\"Number\",\"type\":[\"null\",\"string\"]},{\"name\":\"Type\",\"type\":[\"null\",\"string\"]}]}");
   ...
   */
  public static com.hughes.billing.voipworkorder.dto.avro.InstallPhone.Builder newBuilder() {
    return new com.hughes.billing.voipworkorder.dto.avro.InstallPhone.Builder();
  }
   ...
   * @return A new InstallPhone RecordBuilder
   */
  public static com.hughes.billing.voipworkorder.dto.avro.InstallPhone.Builder newBuilder(com.hughes.billing.voipworkorder.dto.avro.InstallPhone.Builder other) {
    return new com.hughes.billing.voipworkorder.dto.avro.InstallPhone.Builder(other);
  }
   ...
   * @return A new InstallPhone RecordBuilder
   */
  public static com.hughes.billing.voipworkorder.dto.avro.InstallPhone.Builder newBuilder(com.hughes.billing.voipworkorder.dto.avro.InstallPhone other) {
    return new com.hughes.billing.voipworkorder.dto.avro.InstallPhone.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InstallPhone>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.hughes.billing.voipworkorder.dto.avro.InstallPhone.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.hughes.billing.voipworkorder.dto.avro.InstallPhone other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.Number)) {
        this.Number = data().deepCopy(fields()[0].schema(), other.Number);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hughes.billing.voipworkorder.dto.avro.InstallPhone.Builder setNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hughes.billing.voipworkorder.dto.avro.InstallPhone.Builder clearNumber() {
      Number = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hughes.billing.voipworkorder.dto.avro.InstallPhone.Builder setType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hughes.billing.voipworkorder.dto.avro.InstallPhone.Builder clearType() {
      Type = null;
